...
STEP 1 : IF ARR[i] >= ARR.LENGTH , THEN IGNORE THE NO AND MODE FORWARD , AS THAT ELEMENT CANNOT BE PUT INTO CORECT INDEX  CAUSE IT WILL GIVE RRAY OUT OF BOUND EXCEPTION.
